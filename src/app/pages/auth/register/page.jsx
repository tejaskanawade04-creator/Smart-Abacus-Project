    ...
    <div className="min-h-screen bg-[#eceffd] flex items-center justify-center p-4 antialiased font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl bg-white/70 backdrop-blur-md border border-white/80 rounded-3xl p-8 shadow-xl shadow-indigo-100/40 my-6 z-10">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative flex">
                ...
                <input 
                  ...
                  className="w-full bg-white/80 border border-slate-200 rounded-r-xl py-2.5 px-3 text-xs font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select 
                  ...
                  onChange={handleChange}
                  className="w-full bg-white/80 border border-slate-200 rounded-xl py-2.5 pl-11 pr-4 text-xs font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:bg-white appearance-none transition-all cursor-pointer"
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/80 border border-slate-200 rounded-xl py-2.5 pl-11 pr-4 text-xs font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white transition-all resize-none"
                ></textarea>
              </div>
            </div>
          ...
          <button 
            type="submit" 
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 shadow-md shadow-indigo-200 transition-all mt-6 cursor-pointer"
          >
          ...
          <div className="text-center mt-4">
            <p className="text-xs text-slate-400 font-medium">
              ...
              <button 
                ...
                className="text-indigo-600 hover:underline font-bold bg-transparent border-none cursor-pointer"
              >
                Sign In
              </button>
            </p>
