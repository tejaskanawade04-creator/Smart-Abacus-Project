...
export default function Footer() {
  return (
    <footer className="w-full relative z-10 bg-[#070b13]/80 backdrop-blur-md border-t border-slate-800/40 mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          
          {/* १. कंपनी परिचय (Column 1) */}
          <div>
            ...
            {/* सोशल मीडिया आयकॉन्स (तुमचे ओरिजनल SVGs एकदम कडक डिझाईनमध्ये) */}
        ...
        {/* ५. तळटीप (Bottom Footer Area) */}
        <div className="border-t border-slate-900 mt-14 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-[11px] font-mono">
            &copy; {new Date().getFullYear()} Smart Abacus Academy ERP. All Rights Reserved.
          </p>
